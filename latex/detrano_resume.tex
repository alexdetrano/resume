...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\namesection{Alexander}{DeTrano}{\href{mailto:alexdetrano@gmail.com}{alexdetrano@gmail.com} | 239-821-3995 \\ Arlington, VA
}
...
\begin{minipage}[t]{0.66\textwidth} 
	...
	\descript{| Security Consultant}
	\location{Jan 2018 – Present | Herndon, VA}
	...
	\location{June 2015 – Dec 2017 | Hillsboro, OR}
	\vspace{\topsep} % Hacky fix for awkward extra vertical space
	\begin{tightemize}
